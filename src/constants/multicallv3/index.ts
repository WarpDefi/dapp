...
import MULTICALL_ABI_V3 from './abi.json'

const MULTICALL_NETWORKS_V3: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HEDERA_MAINNET]: CHAINS[ChainId.HEDERA_MAINNET].contracts!.multicall,
...
export { MULTICALL_ABI_V3, MULTICALL_NETWORKS_V3 };