...
export const useApproveCallbackFromTradeHook: UseApproveCallbackFromTradeHookType = {
  ...
  [ChainId.HEDERA_MAINNET]: useApproveCallbackFromTrade,
  [ChainId.NEAR_MAINNET]: useApproveCallbackFromTrade,
  [ChainId.NEAR_TESTNET]: useApproveCallbackFromTrade,
...
export type UseApproveCallbackHookType = {
  [chainId in ChainId]: typeof useApproveCallback;
};
...
export const useApproveCallbackHook: UseApproveCallbackHookType = {
  ...
  [ChainId.HEDERA_MAINNET]: useApproveCallback,
  [ChainId.NEAR_MAINNET]: useApproveCallback,
  [ChainId.NEAR_TESTNET]: useApproveCallback,
