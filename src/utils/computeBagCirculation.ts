...
const TREASURY_VESTING_GENESIS = 1622539743
...
export function computeBagCirculation(
	...
	return new TokenAmount(cnr, JSBI.multiply(wholeAmount, JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18))))
}