...
import { Handle, HandleAccent, LabelGroup, Tooltip } from './styles';
import { OffScreenHandle, brushHandleAccentPath, brushHandlePath } from './svg';
import { BRUSH_EXTENT_MARGIN_PX, FLIP_HANDLE_THRESHOLD_PX } from './types';
          ...
          <>
            ...
            {westHandleInView ? (
              ...
              >
                ...
                >
                  <rect y="0" x="-27" height="28" width="54" rx="4" fill="hsl(33 100% 67%)" />
