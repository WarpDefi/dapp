...
import { useMiniChefSPContract, usePairContract } from '../../hooks/useContract';
...
export default function PoolCardV2Super({ MinichefStakingInfo }: { MinichefStakingInfo: MinichefStakingInfo }) {
  ...
  let bonusTokenMultipliers = '{"0":2, "1":1, "2":3.2}';
  ...
  const stakingContract = useMiniChefSPContract();
  ...
  return (
    <Accordion type="single" collapsible>
      <AccordionItem value="item-1">
        <AccordionTrigger className="bg-background rounded-md p-6 space-x-4">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 w-full">
            <div className="flex flex-col items-center">
              ...
              <span>
                {MinichefStakingInfo.stakedAmount.raw.toString() != 0
                  ? numeral((yourTVL as Fraction)?.toFixed(2)).format('$0.00a')
                  : '$0'}
              </span>
            </div>
            ...
            >
              ...
              <TYPE.blackM>{sumApr.toFixed(0)}%</TYPE.blackM>
            </div> */}
